...
if __name__ == "__main__":
    ...
    # ── 洗版测试（聚合容器 + 2 个子目录）──
    test_container("\\\\DS218play\\share\\视频\\其他视频\\洗版测试", "洗版测试", "collection")
    test_leaf("\\\\DS218play\\share\\视频\\其他视频\\洗版测试\\Season 01", "洗版测试/Season 01 (电影)", "movie")
    test_leaf("\\\\DS218play\\share\\视频\\其他视频\\洗版测试\\XiBanCeShi", "洗版测试/XiBanCeShi (电影)", "movie")

    # ── 测试动画合集（tv 容器 + 2 个 season）──
    test_container("\\\\DS218play\\share\\视频\\动画番\\测试动画合集", "测试动画合集", "tv")
    test_leaf("\\\\DS218play\\share\\视频\\动画番\\测试动画合集\\自由的她们", "测试动画合集/自由的她们 (season)", "season")

    # ── 测试文件夹（collection + 3 个 movie）──
    test_container("\\\\DS218play\\share\\视频\\电影\\测试文件夹", "测试文件夹", "collection")
    test_leaf("\\\\DS218play\\share\\视频\\电影\\测试文件夹\\爱乐之城 La La Land (2016)", "测试文件夹/爱乐之城 (电影)", "movie")
    test_leaf("\\\\DS218play\\share\\视频\\电影\\测试文件夹\\白2023", "测试文件夹/白2023 (电影)", "movie")
