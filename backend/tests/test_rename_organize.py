...
TEST_CASES = [
    ("自由的她们 (动画season)", r"\\NAS\share\视频\动画番\测试动画合集\自由的她们"),
    ("爱乐之城 (电影)", r"\\NAS\share\视频\电影\测试文件夹\爱乐之城 La La Land (2016)"),
    ("白2023 (电影)", r"\\NAS\share\视频\电影\测试文件夹\白2023"),
    ("测试动画合集 (tv容器)", r"\\NAS\share\视频\动画番\测试动画合集"),
    ("测试文件夹 (collection)", r"\\NAS\share\视频\电影\测试文件夹"),
]
