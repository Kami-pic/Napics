...
import { buildCardItems, type CardItem } from "./cardGridUtils";
export { getSeasonLabel, type CardItem } from "./cardGridUtils";
...
export default function CardGrid({
  ...
  const items = useMemo(
    () => buildCardItems(currentFolder, groupedVideos),
