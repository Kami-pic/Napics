      ...
      <div className="relative aspect-[2/3] bg-[#111]">
        ...
        {showRank && (
          <div className="absolute top-[6px] left-1">
            <span className={`inline-flex items-center justify-center min-w-[28px] text-[24px] font-bold leading-none tracking-tight drop-shadow-[0_0.5px_2px_rgba(0,0,0,0.2)] ${
              index < 3 ? "text-yellow-400" : "text-white/70"
            }`} style={{ fontFamily: "'Impact', 'Arial Black', 'Helvetica Neue', sans-serif", WebkitTextStroke: "0.5px rgba(0,0,0,0.15)" }}>
              {index + 1}
            </span>
          </div>
        )}
